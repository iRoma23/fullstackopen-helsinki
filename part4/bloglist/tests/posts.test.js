...
describe('favorite blog', () => {
  ...
  test('when list has many blogs, equals to most likes blog', () => {
...
describe('most blogs', () => {
  ...
  test('when list has many blogs, equals to author who has the largest amount of blogs', () => {
...
describe('most likes', () => {
  ...
  test('when list has many blogs, equals to author who has the largest amount of likes', () => {
